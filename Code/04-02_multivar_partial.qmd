...
lm_dayl.apr %>%
  ...
  ggplot(aes(x=mod)) + geom_pointrange(aes(y = estimate,
...
What has happened with **mean_dayl.s, _April** and **sum_p,rcp.mm_Oct** estimates and standard error when modeled i) alone, or with another uncorrelated variable vs. ii) with another correlated variable?
